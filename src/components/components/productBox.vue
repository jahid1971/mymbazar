<template>
    <div v-if="product">
        ...
        <div class="max-w-sm  bg-white  border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 text-center mx-auto">
            ...
            <router-link :to="{name: 'productDeatils' , params : {id:product.id}} ">
                <img class=" zoom w-full  aspect-video  object-cover"  :src="product.imageURL" alt="">
            </router-link>
            ...
            <div class="p-2">
                ...
                <h4 class="mb-3"> Price: $<span>{{ product.price }}</span></h4>
                <router-link v-if="$route.name== 'product' " :to="{name:'editProduct' , params : {id:product.id} }">
                    <a class="edit">
                    Edit
                </a>
                </router-link>

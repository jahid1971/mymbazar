        ...
        <div class="container px-5 py-5 mx-auto flex flex-wrap items-center">
            <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:mx-auto w-full mt-10 md:mt-0">
                ...
                <div class="relative mb-2">
                    ...
                    <input v-model="user.email" type="text" id="full-name" name="full-name" class="myInput">
                </div>
                <div class="relative mb-2">
                    <label for="email" class="leading-7 text-sm text-gray-600">Password</label>
                    <input v-model="user.password" type="email" id="email" name="email" class="myInput">
                </div>
                <button @click="signIn" class="button-blue mt-2">Continue</button>
                <p class="text-sm text-gray-500 mt-3">By continuing, you agree to Simplecoding's Conditions of Use and
                    Privacy Notice.</p>
                ...
                <div class=" text-center">
                    ...
                    <button class="btn btn-sm  bg-opacity-60  lowercase">Create your mymbazar account</button>
                </div>
            </div>
        </div>
    </section>
